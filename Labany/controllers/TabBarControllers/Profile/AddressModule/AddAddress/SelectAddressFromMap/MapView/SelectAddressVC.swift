...
class SelectAddressVC: UIViewController,UIGestureRecognizerDelegate,CLLocationManagerDelegate,MKMapViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        headerView.lblTitle.text = "حدد موقع المستلم"
...
//
        ...
        if(selectedAddress == "")
    {
        ...
        SCLAlertView().showError("", subTitle: "Plz_select_address".localized,closeButtonTitle: "well".localized)
...
extension SelectAddressVC :HeaderDelegate {
    func dismiss() {
        self.dismiss(animated: true, completion: nil)
    }
